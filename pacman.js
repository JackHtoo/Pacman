...
Note: in the video, Dr. Williams uses the setTimeout() method, but here we are going to use a slightly different method called setInterval(), so that you can have practice using this method.
